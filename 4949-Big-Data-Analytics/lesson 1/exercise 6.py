...
for i in range(0, 3):
    ...
    titles = browser.find_elements(By.CSS_SELECTOR, ".DKV0Md")
    formats = browser.find_elements(By.CSS_SELECTOR, ".lyLwlc")
    availability = browser.find_elements(By.CSS_SELECTOR, ".manifestation-item-availability-block-wrap")
    ...
    for i in range(0, NUM_ITEMS):
        ...
        description = getContent(formats[i])
        print("Title: " + title)
    ...
    URL_NEXT = "https://www.google.com/search?q=cats&rlz=1C1GCEA_enCA1004CA1004&sxsrf=AJOqlzV69YdnLgP3iIU6_caOEbiL_UGC9A:1673846576629&ei=MN_EY72BJtLJ9AP8iIboCg&start=10&sa=N&ved=2ahUKEwi92e60rMv8AhXSJH0KHXyEAa0Q8NMDegQIBxAW"
